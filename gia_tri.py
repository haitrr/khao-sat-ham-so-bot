...
def tim_gia_tri_lon_nhat_va_nho_nhat_cua_ham_so(ham_so,bien):
    ...
    if len(buoc_3.dap_an)==1:
        ...
        buoc_4 = huong_dan_giai.LoiGiai('Tìm giá trị hàm số tại các nghiệm tìm được')
        buoc_4.dap_an=list()
...
def tim_gia_tri_lon_nhat_va_nho_nhat_cua_ham_so_trong_mot_khoang_cho_truoc(ham_so,bien,khoang):
    """
...
if __name__ == "__main__":
    ...
    def tim_gia_tri_lon_nhat_va_nho_nhat_cua_ham_so_test():
        ...
        #hs = x**3-3*x**2+1
        hs=4/(1+x**2)
        tim_gia_tri_lon_nhat_va_nho_nhat_cua_ham_so(hs,x).xuat_html("loi_giai.html")

    def tim_gia_tri_lon_nhat_va_nho_nhat_cua_ham_so_trong_khoang_cho_truoc_test():
        hs = (2*x**2+3*x+3)/(x+1)
        k = sympy.Interval(0,2)
        tim_gia_tri_lon_nhat_va_nho_nhat_cua_ham_so_trong_mot_khoang_cho_truoc(hs,x,k).xuat_html("loi_giai.html")
