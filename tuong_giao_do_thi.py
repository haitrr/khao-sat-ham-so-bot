...
def tim_toa_do_giao_diem_voi_duong_thang(ham_so, bien, duong_thang):
    ...
    pt_hoanh_do_giao_diem= phuong_trinh.rut_gon(bat_dang_thuc.bang(pt_hoanh_do_giao_diem.lhs-pt_hoanh_do_giao_diem.rhs,0))

    buoc_1.them_thao_tac(xu_ly_chuoi.boc_mathjax(hang_so.DAU_TUONG_DUONG+xu_ly_chuoi.tao_latex(pt_hoanh_do_giao_diem)))
    ...
    buoc_2.them_thao_tac(xu_ly_chuoi.boc_mathjax(hang_so.DAU_TUONG_DUONG + xu_ly_chuoi.tao_latex(pt_hoanh_do_giao_diem)))
    ...
    if len(nghiem)==0:
        ...
        buoc_2.them_thao_tac(xu_ly_chuoi.boc_mathjax(hang_so.DAU_TUONG_DUONG + xu_ly_chuoi.tao_latex(bat_dang_thuc.bang(bien, nghiem[0]))))
    else:
        buoc_2.them_thao_tac(
            xu_ly_chuoi.boc_mathjax(hang_so.DAU_TUONG_DUONG + "{0}={1}".format(xu_ly_chuoi.tao_latex(bien), xu_ly_chuoi.tao_latex(nghiem))))
    ...
    if buoc_2.dap_an!=[]:
        ...
        # Giai thich
        buoc_3.them_thao_tac("Ta xác định giao điểm theo dạng ({0},{1})".format(xu_ly_chuoi.boc_mathjax(xu_ly_chuoi.tao_latex(bien)), xu_ly_chuoi.boc_mathjax("f({0})".format(xu_ly_chuoi.tao_latex(bien)))))
...
def tim_tham_so_de_ham_so_cat_truc_hoanh_tai_1_diem_duy_nhat(ham_so, bien, tham_so):
    ...
    buoc_3_1.ten_loi_giai = "Tìm {0} để {1} có hai nghiệm phân biệt".format(xu_ly_chuoi.boc_mathjax(xu_ly_chuoi.tao_latex(tham_so)),
    ...
    buoc_3_3.them_thao_tac("Tổng hợp kết quả của hai bước trước ta được {0}".format(
        xu_ly_chuoi.boc_mathjax("{0} \in {1}".format(xu_ly_chuoi.tao_latex(tham_so), xu_ly_chuoi.tao_latex(tong_hop_nghiem_buoc_3)))))
    ...
    buoc_4.them_thao_tac("Vậy với {ts} thì đồ thị hàm số cắt trục hoành tại một điểm duy nhất.".format(
        ts=xu_ly_chuoi.boc_mathjax("{0} \in {1}".format(xu_ly_chuoi.tao_latex(tham_so), xu_ly_chuoi.tao_latex(tong_hop)))
    ))
    # Luu ket qua
...
if __name__ == "__main__":
    ...
    def tim_tham_so_de_ham_so_cat_truc_hoanh_tai_1_diem_duy_nhat_test():
        ...
        tim_tham_so_de_ham_so_cat_truc_hoanh_tai_1_diem_duy_nhat(
            hs, b,tham_so).xuat_html("loi_giai.html")
